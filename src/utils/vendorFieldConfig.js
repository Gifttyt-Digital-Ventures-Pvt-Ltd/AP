export const VENDOR_FIELD_SECTIONS = {
  ...
  ONE_TIME_VENDOR: 'ONE_TIME_VENDOR',
  FOREIGN_VENDOR: 'FOREIGN_VENDOR',
  UDYAM_REGISTRATION_NO: 'UDYAM_REGISTRATION_NO',
  MSME_CATEGORY: 'MSME_CATEGORY',
  IEC_NUMBER: 'IEC_NUMBER',
  TAN: 'TAN',
  TIN: 'TIN',
  STC: 'STC',
  ST_REGISTRATION_NUMBER: 'ST_REGISTRATION_NUMBER',
  PAN_STATUS: 'PAN_STATUS',
  PAN_REFERENCE_NO: 'PAN_REFERENCE_NO',
  NATURE_OF_ASSESSEE: 'NATURE_OF_ASSESSEE',
  TCS_GROUP: 'TCS_GROUP',
  SPECIFIED_PERSON_206AB: 'SPECIFIED_PERSON_206AB',
  TDS_GROUP: 'TDS_GROUP',
  LOW_NIL_DEDUCTION_CERTIFICATE_NO: 'LOW_NIL_DEDUCTION_CERTIFICATE_NO',
...
export const VENDOR_SECTION_TO_FORM_KEY = {
  ...
  [VENDOR_FIELD_SECTIONS.PAYMENT_TERMS]: 'paymentTerms',
  [VENDOR_FIELD_SECTIONS.MODE_OF_DELIVERY]: 'modeOfDelivery',
  [VENDOR_FIELD_SECTIONS.DELIVERY_TERMS]: 'deliveryTerms',
  [VENDOR_FIELD_SECTIONS.VENDOR_STATUS]: 'vendorStatus',
  [VENDOR_FIELD_SECTIONS.ONE_TIME_VENDOR]: 'oneTimeVendor',
  [VENDOR_FIELD_SECTIONS.FOREIGN_VENDOR]: 'foreignVendor',
  [VENDOR_FIELD_SECTIONS.UDYAM_REGISTRATION_NO]: 'udyamRegistrationNo',
  [VENDOR_FIELD_SECTIONS.MSME_CATEGORY]: 'msmeCategory',
  [VENDOR_FIELD_SECTIONS.IEC_NUMBER]: 'iecNumber',
  [VENDOR_FIELD_SECTIONS.TAN]: 'tan',
  [VENDOR_FIELD_SECTIONS.TIN]: 'tin',
  [VENDOR_FIELD_SECTIONS.STC]: 'stc',
  [VENDOR_FIELD_SECTIONS.ST_REGISTRATION_NUMBER]: 'stRegistrationNumber',
  [VENDOR_FIELD_SECTIONS.PAN_STATUS]: 'panStatus',
  [VENDOR_FIELD_SECTIONS.PAN_REFERENCE_NO]: 'panReferenceNo',
  [VENDOR_FIELD_SECTIONS.NATURE_OF_ASSESSEE]: 'natureOfAssessee',
  [VENDOR_FIELD_SECTIONS.TCS_GROUP]: 'tcsGroup',
  [VENDOR_FIELD_SECTIONS.SPECIFIED_PERSON_206AB]: 'specifiedPerson206AB',
  [VENDOR_FIELD_SECTIONS.TDS_GROUP]: 'tdsGroup',
  [VENDOR_FIELD_SECTIONS.LOW_NIL_DEDUCTION_CERTIFICATE_NO]: 'lowNilDeductionCertificateNo',
  [VENDOR_FIELD_SECTIONS.CERTIFICATE_VALIDITY]: 'certificateValidity',
  [VENDOR_FIELD_SECTIONS.TDS_APPLICABLE]: 'tdsApplicable',
};
...
export const VENDOR_FIELD_DEFAULT_LABELS = {
  [VENDOR_FIELD_SECTIONS.VENDOR_ID]: 'Vendor ID',
  [VENDOR_FIELD_SECTIONS.COMPANY_NAME]: 'Vendor Name',
  ...
  [VENDOR_FIELD_SECTIONS.PAYMENT_TERMS]: 'Payment Terms',
  [VENDOR_FIELD_SECTIONS.MODE_OF_DELIVERY]: 'Mode of Delivery',
  [VENDOR_FIELD_SECTIONS.DELIVERY_TERMS]: 'Delivery Terms',
  [VENDOR_FIELD_SECTIONS.VENDOR_STATUS]: 'Vendor Status',
  [VENDOR_FIELD_SECTIONS.ONE_TIME_VENDOR]: 'One Time Vendor',
  [VENDOR_FIELD_SECTIONS.FOREIGN_VENDOR]: 'Foreign Vendor',
  [VENDOR_FIELD_SECTIONS.UDYAM_REGISTRATION_NO]: 'Udyam Registration No.',
  [VENDOR_FIELD_SECTIONS.MSME_CATEGORY]: 'MSME Category',
  [VENDOR_FIELD_SECTIONS.IEC_NUMBER]: 'IEC Number',
  [VENDOR_FIELD_SECTIONS.TAN]: 'TAN',
  [VENDOR_FIELD_SECTIONS.TIN]: 'TIN',
  [VENDOR_FIELD_SECTIONS.STC]: 'STC',
  [VENDOR_FIELD_SECTIONS.ST_REGISTRATION_NUMBER]: 'ST Registration Number',
  [VENDOR_FIELD_SECTIONS.PAN_STATUS]: 'PAN Status',
  [VENDOR_FIELD_SECTIONS.PAN_REFERENCE_NO]: 'PAN Reference No.',
  [VENDOR_FIELD_SECTIONS.NATURE_OF_ASSESSEE]: 'Nature of Assessee',
  [VENDOR_FIELD_SECTIONS.TCS_GROUP]: 'TCS Group',
  [VENDOR_FIELD_SECTIONS.SPECIFIED_PERSON_206AB]: 'Specified Person u/s 206AB',
  [VENDOR_FIELD_SECTIONS.TDS_GROUP]: 'TDS Group/List',
  [VENDOR_FIELD_SECTIONS.LOW_NIL_DEDUCTION_CERTIFICATE_NO]: 'Low/Nil Deduction Certificate No.',
  [VENDOR_FIELD_SECTIONS.CERTIFICATE_VALIDITY]: 'Certificate Validity',
  [VENDOR_FIELD_SECTIONS.TDS_APPLICABLE]: 'TDS Applicable',
};
