...
const VendorPagination = ({ page, totalPages, totalRows, pageSize, onPageChange }) => {
  ...
  return (
    <div className="flex shrink-0 flex-col gap-2 border-t border-border px-4 py-2 sm:flex-row sm:items-center sm:justify-between">
      <p className="text-xs text-muted-foreground" data-testid="vendor-pagination-summary">
        ...
        <PaginationContent className="gap-0.5">
          <PaginationItem>
            <PaginationPrevious
              ...
              data-testid="vendor-pagination-previous"
            />
          </PaginationItem>
          {visiblePageNumbers.map((pageNumber) => (
            <PaginationItem key={pageNumber}>
              <PaginationLink
                ...
                data-testid={`vendor-pagination-page-${pageNumber + 1}`}
              >
                {pageNumber + 1}
              </PaginationLink>
            </PaginationItem>
          ...
          <PaginationItem>
            <PaginationNext
              ...
              data-testid="vendor-pagination-next"
            />
          </PaginationItem>
        </PaginationContent>
      </Pagination>
