...
const invoiceTableHeader = [
  ...
  { key: "invoice_number", title: "Invoice #", headerClassName: "p-3 text-left text-xs font-medium", cellClassName: "p-3   text-sm font-medium" },
  { key: "vendor_name", title: "Vendor", headerClassName: "p-3 text-left text-xs font-medium", cellClassName: "p-3 text-sm" },
  { key: "original_file_name", title: "Original File Name", headerClassName: "p-3 text-left text-xs font-medium", cellClassName: "p-3 text-xs   text-muted-foreground" },
  { key: "gross_amount", title: "Gross Amount", headerClassName: "p-3 text-left text-xs font-medium", cellClassName: "p-3   text-sm font-semibold text-left" },
  { key: "tax_amount", title: "GST / Tax", headerClassName: "p-3 text-left text-xs font-medium", cellClassName: "p-3   text-sm text-left" },
  { key: "tds_amount", title: "TDS", headerClassName: "p-3 text-left text-xs font-medium", cellClassName: "p-3   text-sm text-left" },
  { key: "net_amount", title: "Net Amount", headerClassName: "p-3 text-left text-xs font-medium", cellClassName: "p-3   text-sm font-semibold text-left" },
