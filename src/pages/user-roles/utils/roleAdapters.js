...
export const CUSTOM_ROLE_PERMISSION_MAP = {
  ...
  "payments-requester": { screen: "PAYMENTS", permissionType: "REQUESTER" },
  "payments-approver": { screen: "PAYMENTS", permissionType: "APPROVER" },
  "payments-admin": { screen: "PAYMENTS", permissionType: "ADMIN" },
  ...
  "banking-manage": { screen: "BANKING", permissionType: "MANAGE" },
  ...
  "approval-workflow-view": { screen: "MANAGE_ROLE", permissionType: "WORKFLOW_VIEW" },
  "approval-workflow-manage": { screen: "MANAGE_ROLE", permissionType: "WORKFLOW_MANAGE" },
